...
function IrrigationBlog({activeCategory, openShareId, setOpenShareId, generateShareLink, searchQuery }) {
  const { t } = useTranslation();
  const [readMoreMap, setReadMoreMap] = useState({});
  const [articles, setArticles] = useState([
    {
      id: 301,
      titleKey: "irrigationBlog.cards.0.title",
      shortKey: "irrigationBlog.cards.0.short",
      contentKey: "irrigationBlog.cards.0.content",
      image: "irrigation.jpg",
      dateKey: "irrigationBlog.cards.0.date",
      isBookmarked: false
    },
    {
      id: 302,
      titleKey: "irrigationBlog.cards.1.title",
      shortKey: "irrigationBlog.cards.1.short",
      contentKey: "irrigationBlog.cards.1.content",
      image: "sprinkler.png",
      dateKey: "irrigationBlog.cards.1.date",
      isBookmarked: false
    },
    {
      id: 303,
      titleKey: "irrigationBlog.cards.2.title",
      shortKey: "irrigationBlog.cards.2.short",
      contentKey: "irrigationBlog.cards.2.content",
      image: "water-conservation.jpg",
      dateKey: "irrigationBlog.cards.2.date",
      isBookmarked: false
    }
  ]);

  if (activeCategory !== 'irrigation' && activeCategory !== 'all') return null;
      ...
      {filteredArticles.map(article => (
        <div className="blog-article-card" key={article.id}>
          <div className="blog-card-header">
            ...
            <span className="blog-category-badge">{t("irrigationBlog.category")}</span>
            <button
          ...
          <div className="blog-card-footer">
            ...
            >
              {readMoreMap[article.id] ? t("irrigationBlog.read_less") : t("irrigationBlog.read_more")} 
              <FiArrowRight />
            </button>
            ...
            <div className="blog-share-wrapper">
              ...
              >
                <FiShare2 /> {t("irrigationBlog.share")}
              </button>
