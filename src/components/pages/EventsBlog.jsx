...
function EventsBlog({ openShareId, setOpenShareId, generateShareLink, activeCategory, searchQuery }) {
  const { t } = useTranslation();
  const [readMoreMap, setReadMoreMap] = useState({});
  const [articles, setArticles] = useState([
    {
      id: 501,
      titleKey: "eventsBlog.cards.0.title",
      shortKey: "eventsBlog.cards.0.short",
      contentKey: "eventsBlog.cards.0.content",
      image: "delhi_action.jpg",
      dateKey: "eventsBlog.cards.0.date",
      isBookmarked: false
    },
    {
      id: 502,
      titleKey: "eventsBlog.cards.1.title",
      shortKey: "eventsBlog.cards.1.short",
      contentKey: "eventsBlog.cards.1.content",
      image: "farmermeeting.jpg",
      dateKey: "eventsBlog.cards.1.date",
      isBookmarked: false
    },
    {
      id: 503,
      titleKey: "eventsBlog.cards.2.title",
      shortKey: "eventsBlog.cards.2.short",
      contentKey: "eventsBlog.cards.2.content",
      image: "sikar.jpg",
      dateKey: "eventsBlog.cards.2.date",
      isBookmarked: false
    }
  ]);

  // 🟡 Add this conditional return

  if (activeCategory !== 'events' && activeCategory !== 'all') return null;
      ...
      {filteredArticles.map(article => (
        <div className="blog-article-card" key={article.id}>
          <div className="blog-card-header">
            ...
            <span className="blog-category-badge">{t("eventsBlog.category")}</span>
            <button
          ...
          <div className="blog-card-footer">
            ...
            >
              {readMoreMap[article.id]
                ? t("eventsBlog.read_less")
                : t("eventsBlog.read_more")}
              <FiArrowRight />
            </button>
