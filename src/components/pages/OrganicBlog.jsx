...
function OrganicBlog({ activeCategory, openShareId, setOpenShareId, generateShareLink, searchQuery }) {
  ...
  const [articles, setArticles] = useState([
    {
      id: 201,
      titleKey: "organicBlog.cards.0.title",
      shortKey: "organicBlog.cards.0.short",
      contentKey: "organicBlog.cards.0.content",
      image: "organic.png",
      dateKey: "organicBlog.cards.0.date",
      isBookmarked: false
    },
    {
      id: 202,
      titleKey: "organicBlog.cards.1.title",
      shortKey: "organicBlog.cards.1.short",
      contentKey: "organicBlog.cards.1.content",
      image: "compsitOrg.png",
      dateKey: "organicBlog.cards.1.date",
      isBookmarked: false
    },
    {
      id: 203,
      titleKey: "organicBlog.cards.2.title",
      shortKey: "organicBlog.cards.2.short",
      contentKey: "organicBlog.cards.2.content",
      image: "fasalChakran.png",
      dateKey: "organicBlog.cards.2.date",
      isBookmarked: false
    }
  ]);

  if (activeCategory !== 'organic' && activeCategory !== 'all') return null;
      ...
      {filteredArticles.map(article => (
        <div className="blog-article-card" key={article.id}>
          <div className="blog-card-header">
            ...
            <span className="blog-category-badge">{t("organicBlog.category")}</span>
            <button
          ...
          <div className="blog-card-footer">
            ...
            >
              {readMoreMap[article.id] ? t("organicBlog.read_less") : t("organicBlog.read_more")} 
              <FiArrowRight />
            </button>
